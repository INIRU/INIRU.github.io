...
function Experience(): JSX.Element {
  ...
  return (
    <div className="experi-container w-100 mt-5 shadow-sm">
      ...
      <div className={`mt-4 w-100 d-flex gap-3 ${fade}`}>
        <FontAwesomeIcon
          className="ps-2 experi-page align-self-center"
          icon={faAngleLeft}
          onClick={() => {
            PageBack();
          }}
        ...
        <FontAwesomeIcon
          className="pe-2 experi-page align-self-center"
          icon={faAngleRight}
          onClick={() => {
            PageNext();
          }}
      ...
      <div className="experi-page-status d-flex justify-content-center gap-2 mb-3">
